...
void loop()
 ...
 //Serial.print((float)sholatT[0]);
    ...
    runningTextOut(drawTextOut(),75,2);    
    drawAzzan(100);                                             // addr: 100 show Azzan
    runningAfterAdzan(101);                                            // addr: 101 show Iqomah
...
//    else if(RunFinish==100)           {RunSel = 101; RunFinish =0;}               //after Azzan Sholah (Iqomah)
    ...
    if(RunFinish==100) {RunSel = 101; RunFinish =0; reset_x=1;}       //after Iqomah(anim 101) set Message Sholah (anim 102)   
    if(RunFinish==101) {RunSel = 1; RunFinish =0;}                  //after Message Sholah (anim 102) set Blink Sholah(anim 104) 
